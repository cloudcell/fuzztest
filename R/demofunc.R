################################################################################
# Description: A Function to Be Used as an Example
#              (a work in progress)
# Author: cloudcello 
# Date: 2016-02-29
################################################################################
...
demofunc <- function(x, y, option, suboption)
{
    switch(option,
           "a"={
               ...
               if(abs(x-y)<0.1) stop("demo bug #2")
           },
           "b"={
               switch(suboption,
                      "a"={           },
               ...
               if(abs(x-y/2)<0.1) stop("demo bug #3")
           },
           "c"={
               switch(suboption,
                      "a"={           },
               ...
               if(abs(x-y/x^2)<0.01) stop("demo bug #4")
           },
           "d"={
               switch(suboption,
                      "a"={           },
               ...
               if(abs(x-y/x^0.5)<0.01) stop("demo bug #5")
           },
           "e"={
               x <- 1
               switch(suboption,
               ...
               if(abs(x %% 5 - y)<0.01) stop("demo bug #6")
           },
           "f"={
               switch(suboption,
                      "a"={ stop("demo bug #7") },
               ...
               if(abs(x %/% 5 - y)<0.01) stop("demo bug #8")
           },
           { stop("Wrong option (valid 'FAIL')") }
    )
    
    if(abs(x-y*2)<0.1) stop("demo bug #9")
    if(abs(x-y*3)<0.1) stop("demo bug #10")
